...
<h1 class="titleseller">Our Products</h1>
<a href="allproducts.php?cat=0" class="viewall">View All</a>

</div>
  <swiper-container class="mySwiper" pagination="true" pagination-clickable="true" slides-per-view="4" grid-rows="2"
    space-between="30">
